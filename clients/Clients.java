...
public class Clients {
	...
	public Clients(String arg, int arg1, String name, String dataUser) throws Exception {
		...
		server = new ConnectServer(nameUser);
		(new Request()).start();
	}
	...
	public void request() throws Exception {
		...
		SocketAddress addrServer = new InetSocketAddress(IPserver, serverPort);
		socketClient.connect(addrServer);
	...
	public void intialNewChat(String IP, int host, String guest) throws Exception {
		...
		//not if
		new ClientsChatGUI(nameUser, guest, connclient , clientPort);
	}
	public void intialNewGroupChat(ArrayList<String> ListIP, ArrayList<Integer> ListPort, ArrayList<String> Listguest) throws Exception {
		...
		ListPort_hasCreator.add(clientPort);
	...
	public void exit() throws IOException, ClassNotFoundException {
		isStop = true;
		socketClient = new Socket();
		SocketAddress addressServer = new InetSocketAddress(IPserver, serverPort);
