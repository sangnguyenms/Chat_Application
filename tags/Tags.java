...
public class Tags {
	...
	public static String PEER_PASS_OPEN_TAG = "<PEER_PASS>";// 34
	public static String PEER_PASS_CLOSE_TAG = "</PEER_PASS>";// 35
	public static String PEER_CONPASS_OPEN_TAG = "<PEER_CONPASS>";// 36
	public static String PEER_CONPASS_CLOSE_TAG = "</PEER_CONPASS>";// 37 
	public static String PEER_STATE_OPEN_TAG = "<PEER_STATE>";// 38
	public static String PEER_STATE_CLOSE_TAG = "</PEER_STATE>";// 39   
	public static String PEER_LISTFR_OPEN_TAG = "<PEER_LISTFR>";// 40
	public static String PEER_LISTFR_CLOSE_TAG = "</PEER_LISTFR>";// 41  
	public static String PEER_LISTREFR_OPEN_TAG = "<PEER_LISTREFR>";// 42
	public static String PEER_LISTREFR_CLOSE_TAG = "</PEER_LISTREFR>";// 43
	public static String ADDFR_OPEN_TAG = "<ADDFR>";// 42
	public static String ADDFR_CLOSE_TAG = "</ADDFR>";// 43
	public static String SENDER_OPEN_TAG = "<SENDER>";// 42
	public static String SENDER_CLOSE_TAG = "</SENDER>";// 43
	public static String REICEIVER_OPEN_TAG = "<REICEIVER>";// 42
	public static String REICEIVER_CLOSE_TAG = "</REICEIVER>";
	public static String ACCEPTFR_OPEN_TAG = "<ACCEPTFR>";// 42
	public static String ACCEPTFR_CLOSE_TAG = "</ACCEPTFR>";// 43
	public static String GROUPCHAT_REQ_OPEN_TAG = "<GROUP_CHAT>";// 42
	public static String GROUPCHAT_REQ_CLOSE_TAG = "</GROUP_CHAT>";// 43
	public static String GROUPNAME_OPEN_TAG = "<GROUP_NAME>";// 42
	public static String GROUPNAME_CLOSE_TAG = "</GROUP_NAME>";// 43
	// ------------------
