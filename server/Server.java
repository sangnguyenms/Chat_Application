...
public class Server {
	...
	private static ArrayList<UserFriend> listFriend = null;
	private static ArrayList<UserFriend> listRequestFr = null;
	...
	private ArrayList<UserFriend> loadlistFriend() throws IOException{
		ArrayList<UserFriend> listFriend =new ArrayList<UserFriend>();
	...
	public static void storeListFriend(ArrayList<UserFriend> listFriend) throws IOException {
		FileWriter out=null;
		UserFriend friend=new UserFriend();
		try {
	...
	private ArrayList<UserFriend> loadlistRequestFriend() throws IOException{
		ArrayList<UserFriend> listFriend =new ArrayList<UserFriend>();
		UserFriend newFriend= new UserFriend();
		BufferedReader br =null;
		try {
	...
	public static void storeListRequestFriend(ArrayList<UserFriend> listFriend) throws IOException {
		FileWriter out=null;
		UserFriend friend=new UserFriend();
		try {
